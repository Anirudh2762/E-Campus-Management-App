...
def teacher_exam_view(request):
    return render(request,'staff_template/teacher_exam.html')
...
def teacher_add_exam_view(request):
    ...
    if request.method=='POST':
        ...
        return HttpResponseRedirect('/staff_template/teacher-view-exam')
    return render(request,'staff_template/teacher_add_exam.html',{'courseForm':courseForm})

def teacher_view_exam_view(request):
    courses = models.Course.objects.all()
    return render(request,'staff_template/teacher_view_exam.html',{'courses':courses})
...
def teacher_question_view(request):
    return render(request,'staff_template/teacher_question.html')
...
def teacher_add_question_view(request):
    ...
    if request.method=='POST':
        ...
        if questionForm.is_valid():
            ...
            print("form is invalid")
        return HttpResponseRedirect('/staff_template/teacher-view-question')
    return render(request,'staff_template/teacher_add_question.html',{'questionForm':questionForm})

def teacher_view_question_view(request):
    courses= models.Course.objects.all()
    return render(request,'staff_template/teacher_view_question.html',{'courses':courses})

def see_question_view(request,pk):
    questions=models.Question.objects.all().filter(course_id=pk)
    return render(request,'staff_template/see_question.html',{'questions':questions})

...
urlpatterns = [
    ...
    path('admin-course', HodViews.admin_course_view,name='admin-course'),
    path('admin-add-course', HodViews.admin_add_course_view,name='admin-add-course'),
    path('admin-view-course', HodViews.admin_view_course_view,name='admin-view-course'),
    path('delete-course/<int:pk>', HodViews.delete_course_view,name='delete-course'),

    path('admin-question', HodViews.admin_question_view,name='admin-question'),
    path('admin-add-question', HodViews.admin_add_question_view,name='admin-add-question'),
    path('admin-view-question', HodViews.admin_view_question_view,name='admin-view-question'),
    path('view-question/<int:pk>', HodViews.view_question_view,name='view-question'),
    path('delete-question/<int:pk>', HodViews.delete_question_view,name='delete-question'),
######
    #path('admin-view-student', HodViews.admin_view_student_view,name='admin-view-student'),
    path('admin-view-student-marks', HodViews.admin_view_student_marks_view,name='admin-view-student-marks'),
    path('admin-view-marks/<int:pk>', HodViews.admin_view_marks_view,name='admin-view-marks'),
    path('admin-check-marks/<int:pk>', HodViews.admin_check_marks_view,name='admin-check-marks'),
...
##########
    path('teacher-exam', StaffViews.teacher_exam_view,name='teacher-exam'),
    path('teacher-add-exam', StaffViews.teacher_add_exam_view,name='teacher-add-exam'),
    path('teacher-view-exam', StaffViews.teacher_view_exam_view,name='teacher-view-exam'),
    path('delete-exam/<int:pk>', StaffViews.delete_exam_view,name='delete-exam'),


    path('teacher-question', StaffViews.teacher_question_view,name='teacher-question'),
    path('teacher-add-question', StaffViews.teacher_add_question_view,name='teacher-add-question'),
    path('teacher-view-question', StaffViews.teacher_view_question_view,name='teacher-view-question'),
    path('see-question/<int:pk>', StaffViews.see_question_view,name='see-question'),
    path('remove-question/<int:pk>', StaffViews.remove_question_view,name='remove-question'),
